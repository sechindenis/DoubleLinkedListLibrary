namespace DoubleLinkedListLibrary.Test
{
    public class RemoveFirstWithValue
    {
        ...
        {
            DoubleLinkedList list = new DoubleLinkedList(RemoveFirstWithValueMock.GetMockParametrForRemoveFirstByValue(value));
        ...
        {
            DoubleLinkedList actual = new DoubleLinkedList(RemoveFirstWithValueMock.GetMockParametrForRemoveFirstByValue(value));
            actual.RemoveFirstWithValue(value);
            DoubleLinkedList expected = new DoubleLinkedList(RemoveFirstWithValueMock.GetMockExpectedForRemoveFirstByValue(value));
        ...
        {
            DoubleLinkedList actual = new DoubleLinkedList(new int[] { 1 });
